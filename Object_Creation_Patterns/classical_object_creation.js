...
const doctor = new Doctor('foo1', 'bar1', 21, 'gender', 'Pediatrics');
...
const graduateStudent = new GraduateStudent('foo2', 'bar2', 21, 'gender', 'BS Industrial Engineering', 'MS Industrial Engineering');
